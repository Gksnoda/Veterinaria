  ...
  return (
    <section className="bg-imagemHome flex flex-col w-screen h-screen justify-center items-center md:justify-center md:items-center lg:flex-row lg:justify-center lg:items-center">
      <div className="flex flex-col justify-center mt-0 md:items-center lg:mt-0 lg:ml-32 md:mt-0 ">
        <h1 className="text-greeny font-bold text-3xl text-center lg:text-7xl md:text-4xl md:text-center lg:w-[550px] lg:text-left lg:mb-12 lg:mt-0">
          TRANSFORME A SAUDE DO SEU AMIGO ANIMAL!
        </h1>
      ...
      <div>
        <h2 className="text-greeny w-[300px] md:text-center text-2xl mt-10 text-left md:ml-0 lg:mt-0 lg:text-4xl lg:w-[450px] lg:ml-36">
          Com nossa equipe especializada e técnicas comprovadas,
          ajudamos você e seu animal a superar todos os seus problemas!
        </h2>
      </div>
    </section>
  );
